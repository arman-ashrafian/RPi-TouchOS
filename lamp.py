...
"\n"
"")
        self.button_on = QtWidgets.QPushButton(Form)
        self.button_on.setGeometry(QtCore.QRect(110, 170, 241, 171))
        self.button_on.setObjectName("button_on")
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(230, 20, 371, 71))
        font = QtGui.QFont()
